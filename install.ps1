...
if (Test-Command "openclaw") {
    Write-Host "  [OK] OpenClaw already installed" -ForegroundColor Green
} else {
...
Write-Host "  [OK] Framework downloaded" -ForegroundColor Green
Write-Host ""
...
try {
    ...
    if ($trialKey) {
        ...
        Write-Host "  [OK] Trial key: $masked (7 days, limited quota)" -ForegroundColor Green
    }
} catch {
